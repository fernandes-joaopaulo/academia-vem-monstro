...
try
{
    ...
    $result = $conn->query("SELECT * FROM tb_aparelhos_musculacao");
    ...
    if ($count > 0) {
        ...
        echo "</td>\n";
        echo "<td>\n";
        echo "<b>Carga Máxima</b>\n";
        echo "</td>\n";
        echo "<td>\n";
        echo "<b>Carga Mínima</b>\n";
        echo "</td>\n";
        echo "<td>\n";
        echo "<b>Material</b>\n";
        echo "</td>\n";
...
// cria o link para o programa alteracao_receitas.php passando o código da receita a ser alterada/excluída            
            echo "<a href='alteracao_exclusao_aparelhos_musculacao.php?codigo=" . $row->codigo . "'>";
